...
{
    /// <summary>
    /// Class for Generating a Skyscraper
    /// </summary>
    public class Skyscraper : Area
    {
        ...
        public override GameObject BuildAreaObject()
        {
            ...
            float houseHeight = Random.Range(_mGDS.MapSizeY + _mGDS.OffsetY_Ground, _mGDS.MapSizeY + _mGDS.OffsetY_Ground + _mGDS.OffsetY_Ceiling);
            houseHeight = _mGDS.RoomHeight * (int)(houseHeight / _mGDS.RoomHeight);
